        ...
        <h1 class="header">
            ...
            <div class="container">
             ...
             <div class="col-lg-6">
              ...
              <div class="col-lg-6">
                <div class="form">
                    <form method="POST" action="up_room.php">
                       <div>
                        <input type="text" id="NurseID" name="RoomNo" required>
                        <label>Room No To Update:</label>
                        </div>
                        <div>
                        <input type="text" id="NurseName" name="BedQnty" >
                        <label>Bed Quantity:</label>
                        </div>
                        <div>
                        <input type="text" id="NurseCon" name="NurseID" >
                        <label>Nurse ID In Charge:</label>
                        </div>
