        ...
        <h1 class="header">
            ...
            <div class="container">
             ...
             <div class="col-lg-6">
              ...
              <div class="col-lg-6">
                <div class="form">
                    <form method="POST" action="up_nurse.php">
                       <div>
                        <input type="text" id="NurseID" name="NurseID" required>
                        <label>Nurse ID To Update:</label>
                        </div>
                        <div>
                        <input type="text" id="NurseName" name="NurseName" >
                        <label>Nurse Name:</label>
                        </div>
                        <div>
                        <input type="text" id="NurseCon" name="NurseCon" >
